...
export class Backend implements backendInterface {
    ...
    async getLastFetchedAt(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getLastFetchedAt();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getLatestArticles(): Promise<Array<Article>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLatestArticles();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
